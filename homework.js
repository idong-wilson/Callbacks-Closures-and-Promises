...
function printMovieInfo(Name){
    getMovieInfo(Name)
        .then(movie => console.log(`${movie.title}, a story of ${movie.description} that runs for ${movie.runtime} minutes, directed by ${movie.director}.`))
